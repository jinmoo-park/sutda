...
친구들끼리만 접속해서 즐기는 온라인 한국 화투 카드 게임 섯다. 방장이 링크를 공유하면 초대받은 플레이어들이 닉네임만으로 참여할 수 있는 웹 앱이다. 하우스룰(rule_draft.md)을 기반으로 오리지날·세장·공유패·후회의섯다·인디언섯다 5가지 게임 모드와 구사 재경기, 땡값 등 하우스 룰을 모두 구현한다.
...
- [ ] 인디언섯다: 1장 앞면 반대(나만 못 봄) → 베팅 → 1장 추가(나만 봄) → 최종 베팅
