...
Plans:
- [ ] 04-01-PLAN.md — 프로토콜 타입 확장 + GameEngine FSM 핵심 (선 결정, 등교, 셔플, 기리, 배분) (SEAT-01~03, DECK-02~05, MODE-OG-01)
- [ ] 04-02-PLAN.md — 베팅 시스템 + 쇼다운 + 승자 판정 + 전체 플로우 통합 (BET-01~06, MODE-OG-02)
