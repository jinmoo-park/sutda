...
| Display | 26px (text-[26px] 기존 팟 금액) | 700 (bold) | 1.1 | 팟 금액, 핵심 숫자 |

출처: `GameTable.tsx` (text-[26px] font-bold), `HandPanel.tsx` (text-sm font-semibold), `DealerSelectModal.tsx` 패턴
